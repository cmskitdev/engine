...
// func NewExportOperation(engine *Engine[any], config ExportConfig) *ExportOperation {
...
// 	ItemsSucceeded map[common.ObjectType]int64 `json:"items_succeeded"`
...
// 			ItemsSucceeded: make(map[common.ObjectType]int64),
...
// func (op *ExportOperation) updateStats(stats *ExportStats, result PipelineResult[any]) {
// 	stats.TotalItems++
...
// func (b *ExportBuilder) From(source PluginSource[any]) *ExportBuilder {
// 	b.request.Source = source
// 	return b
// }

// // To sets the data destination
// func (b *ExportBuilder) To(destination PluginDestination[any]) *ExportBuilder {
// 	b.request.Destination = destination
// 	return b
// }

// // Include adds object types to the export scope
// func (b *ExportBuilder) Include(objectTypes ...common.ObjectType) *ExportBuilder {
...
// func (b *ExportBuilder) Build(engine *Engine[any]) *ExportOperation {
// 	return NewExportOperation(engine, b.config)
// }

// // Execute builds and executes the export operation
// func (b *ExportBuilder) Execute(ctx context.Context, engine *Engine[any]) (*ExportResult, error) {
